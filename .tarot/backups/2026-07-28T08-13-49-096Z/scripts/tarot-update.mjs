...
if (!existsSync(packagePath)) {
  ...
  if (!existsSync(releasePath)) {
    ...
    const scriptsCurrent = !scriptConflict && targetPackage.scripts?.tarot === tarotScript && targetPackage.scripts?.['tarot:update'] === updaterScript && targetPackage.scripts?.['tarot:storm'] === stormScript;
    ...
    if (verifyOnly) {
      ...
      targetPackage.scripts = { ...(targetPackage.scripts || {}), 'tarot:update': updaterScript, 'tarot:storm': stormScript };

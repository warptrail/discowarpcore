...
if (!existsSync(packagePath)) {
  ...
  if (!existsSync(releasePath)) {
    ...
    const scriptsCurrent = !scriptConflict && targetPackage.scripts?.tarot === tarotScript && targetPackage.scripts?.['tarot:agent'] === agentScript && targetPackage.scripts?.['tarot:update'] === updaterScript && targetPackage.scripts?.['tarot:storm'] === stormScript && targetPackage.scripts?.['tarot:install'] === installerScript;
    ...
    if (verifyOnly) {
      ...
      targetPackage.scripts = { ...(targetPackage.scripts || {}), 'tarot:agent': agentScript, 'tarot:update': updaterScript, 'tarot:storm': stormScript, 'tarot:install': installerScript };
